...
class HikashopTestHelper {
	...
	/**
	 * HikashopTestHelper constructor.
	 *
	 * @param \Hikashop\HikashopTest|\Hikashop\HikashopFullTest $hikashop_test
	 */
	public function __construct( $hikashop_test ) {
		$this->main_test = $hikashop_test;
		$this->wd = $hikashop_test->wd;
	 ...
	 * @throws \Facebook\WebDriver\Exception\UnexpectedTagNameException
	 */
	public function selectByText( $selectQuery, $value ) {
		$select = new WebDriverSelect( $this->find( $selectQuery ) );
		$select->selectByVisiblePartialText( $value );
